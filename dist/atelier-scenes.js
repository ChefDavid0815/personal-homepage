...
function addIndex(){
  ...
  if(grid&&!document.querySelector('.scene-index--works')){
    ...
    const projects=[['atlas','ATLAS','07','atlas'],['chroma','CHROMA','06','chroma'],['projectlens','PROJECTLENS','05','lens'],['festival-toolkit','FESTIVAL','04','festival'],['axiom','AXIOM','03','axiom'],['folio','FOLIO','02','folio'],['nba-after-hours','AFTER HOURS','01','court']];
