...
export const messages = {
  ...
  'gallery.meta': ['ChefZC 的数字作品陈列室。以不同的视角，探索 AI 概念、交互体验与小工具。', 'A collection by ChefZC. Explore AI concepts, digital experiences, and small tools from a different perspective.'],
  ...
  'gallery.selected': ['精选实验', 'SELECTED EXPERIMENTS'],
  'gallery.notice': ['<span class="concept-symbol" aria-hidden="true">◇</span> 概念设计 <span>/</span> 展示示例', '<span class="concept-symbol" aria-hidden="true">◇</span> Concept designs <span>/</span> Demo collection'],
