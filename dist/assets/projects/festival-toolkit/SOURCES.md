# Festival Toolkit exhibition assets

- `workspace.png` and `workspace-en.png`: original app screenshots from local QA, version 0.1.1, disconnected state. No player save, username or private path is shown.
- `cover.svg`: original code-native festival pass artwork created for ChefZC. Exhibition uses pale mint, sky blue and pink; the software screenshot preserves its actual palette.
- `barlow-condensed.woff2`: the app's Barlow Condensed font, SIL OFL 1.1; see FONT-LICENSE.txt.
