export const modelsPost = {
 ...
 zh: {
  ...
  sections: [
   ...
   { title: '收藏，也想让别人打开', paragraphs: ['这次最想做好的，是“看模型”这件事本身。干脆把篮球的热闹也放进来：亮黄撞上钴蓝，玫红像场边的呐喊，漫画网点和大字围着玻璃盒展开。模型在里面慢慢转，周围的画面像一张活起来的收藏卡。你也可以拖动、暂停，或者放大看一个细节。它们不是扁平海报，是真正在浏览器里加载的 3D。', '建模文件已整理成独立下载：保留模型、必要贴图和导入说明，不把参考资料库一起塞进去。免费指下载不收费，第三方素材、标志和人物相关权利仍按原有归属与条款处理。', '从篮球游戏，到球馆和脸模，方向好像越来越多了。但开始它们的原因其实很简单：喜欢，所以想试着做点东西。'] },
  ],
