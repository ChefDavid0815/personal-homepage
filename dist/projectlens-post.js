export const lensPost={
 ...
 zh:{
  ...
  sections:[
   ...
   {title:'第一枚透镜，先走到这里',paragraphs:['现在是 0.1.0，一个 Windows 桌面 MVP。基础规则测试和构建通过了，但这还不意味着它能找出所有问题。静态启发式规则会误报，也会漏掉东西；编译、测试和真正的安全审查，仍然要各自认真做。','第一版界面是中文，项目说明和这篇文章都有英文版。Windows 便携包已经放到 GitHub，当前没有代码签名。它还没有可独立扫描目录的网页版，所以网页里保留的是展柜和介绍。','喜欢做工具，大概就是因为这种小小的满足感：前几天还在想“要是有一个就好了”，今天它已经有了名字，也有了自己的位置。下一次打开一个项目，就从这里再看一眼。']}
