...
export function festivalArtwork() {
  return `<div class="festival-stage" aria-hidden="true"><div class="festival-orbit"></div><span class="festival-pink-label">NEXT CHAPTER<br>EDITION / 02</span><div class="festival-ticket-wrap">${festivalTicket(true)}<span class="festival-garage-seal"><svg viewBox="0 0 80 44" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M8 29v-7l9-3 11-12h25l13 12 7 4v9H8m9-13h49M31 8l-5 12m24-12 7 12"/><circle cx="22" cy="32" r="6" fill="#bfdcf4"/><circle cx="60" cy="32" r="6" fill="#bfdcf4"/></svg><b>647</b><small>THE GARAGE<br>IS OPEN.</small></span></div><div class="festival-weather"><span class="festival-season-icon">${festivalIcon(0)}</span><div><small>SEASON / <span class="festival-season-index">01</span></small><b class="festival-season-name">SUMMER</b></div><span>↗</span></div><div class="festival-track"><svg viewBox="0 0 440 70"><path d="M0 48H48C92 48 98 18 150 18H235C285 18 278 54 330 54H440"/></svg><span>START SOMETHING GOOD.</span></div></div>`;
}
const stats = () => `<dl class="festival-stats"><div><dt>647</dt><dd>${t('festival.cars')}</dd></div><div><dt>↗</dt><dd>${t('festival.content')}</dd></div><div><dt>↶</dt><dd>${t('festival.recovery')}</dd></div></dl>`;
...
const captures = { playlist: 'workspace-v0.2.png', garage: 'garage-v0.2.png' };
