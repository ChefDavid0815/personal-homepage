...
function overview() {
  ...
  document.querySelector('meta[name="description"]').content = copy('ChefZC 的随笔：生活、NBA After Hours、Folio 与 AXIOM 的制作手记。', 'Notes by ChefZC: life, NBA After Hours, Folio and AXIOM.');
...
function figure(src, alt, caption, type = '') {
  const size = src.includes('/axiom/') ? (src.endsWith('.svg') ? [400,280] : [2283,1437]) : src.includes('/folio/') ? [1426,924] : src.includes('hero-asterisk') ? [1254,1254] : [1440,900];
